...
const aviso = document.querySelector(".regras-texto p");
const input = document.querySelector(".caixa-texto");
const botao_criptografar = document.querySelector(".botao-criptografar");
const botao_descriptografar = document.querySelector(".botao-descriptografar");

const mensagem_titulo = document.querySelector(".mensagem-resultado h2");
const mensagem_paragrafo = document.querySelector(".mensagens p");
const texto_conteudo_direita = document.querySelector(".texto-resultado");
const imagens_conteudo_direita = document.querySelector(".elementos-resultado");
const botao_copiar = document.querySelector(".copiar-resultado");
